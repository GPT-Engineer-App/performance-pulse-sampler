...
const Index = () => {
  ...
  const catBreeds = [
    ...
    { name: "Persian", description: "Characterized by their flat faces and long, luxurious fur." },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-5xl font-bold mb-8 text-center text-primary">All About Cats</h1>
